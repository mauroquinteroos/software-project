# Generated by Django 3.1.1 on 2020-09-15 19:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Empleado',
            fields=[
                ('codPers', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Proyecto',
            fields=[
                ('codPyto', models.IntegerField(primary_key=True, serialize=False)),
                ...
                ('valRefer', models.DecimalField(decimal_places=2, max_digits=6)),
                ('costoTotal', models.DecimalField(decimal_places=2, max_digits=6)),
                ('costDirecto', models.DecimalField(decimal_places=2, max_digits=6)),
                ('costGGen', models.DecimalField(decimal_places=2, max_digits=6)),
                ...
                ('emplJefeProj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='T.empleado')),
            ],
        ),
        migrations.CreateModel(
            name='Ruta',
            fields=[
                ('codRutaPy', models.IntegerField(primary_key=True, serialize=False)),
                ...
                ('nroKms', models.DecimalField(decimal_places=2, max_digits=6)),
                ...
                ('codPyto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='T.proyecto')),
                ('elaboradorPor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='T.empleado')),
            ],
        ),
        migrations.CreateModel(
            name='Tramo',
            fields=[
                ('codTramoPy', models.IntegerField(primary_key=True, serialize=False)),
                ('nroVersion', models.IntegerField()),
                ...
                ('nroKmsTramo', models.DecimalField(decimal_places=2, max_digits=6)),
                ('zonaGPS', models.CharField(max_length=25)),
                ('progInicio', models.CharField(max_length=25)),
                ...
                ('vigencia', models.CharField(max_length=1)),
                ('codRutaPy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='T.ruta')),
            ],
        ),
    ]
